...
- Tables
- Images
- Typographic replacements (not supported on web)
...
- **1.3.10** (2026-05-18, 7:20pm) - Improved auth, preview markdown text is selectable, auto log user out if their token is expired (10 days).
